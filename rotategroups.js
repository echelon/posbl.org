...
var rotate_z1 = function()
{
	...
	var swapCubes = function() {
		var t;
		t = rubik.rubik[0][2][2];
		rubik.rubik[0][2][2] = rubik.rubik[2][2][2];
		rubik.rubik[2][2][2] = rubik.rubik[2][0][2];
		rubik.rubik[2][0][2] = rubik.rubik[0][0][2];
		rubik.rubik[0][0][2] = t;

		t = rubik.rubik[1][2][2];
		rubik.rubik[1][2][2] = rubik.rubik[2][1][2];
		rubik.rubik[2][1][2] = rubik.rubik[1][0][2];
		rubik.rubik[1][0][2] = rubik.rubik[0][1][2];
		rubik.rubik[0][1][2] = t;
	}

	installMatrices();
	installTween(newAngle, oldAngle, 'z', swapCubes);
}

var rotate_z2 = function()
{
	if(ROTATE_LOCK) { return; }
	ROTATE_LOCK = true;
	...
	var swapCubes = function() {
		var t;
		t = rubik.rubik[0][2][1];
		rubik.rubik[0][2][1] = rubik.rubik[2][2][1];
		rubik.rubik[2][2][1] = rubik.rubik[2][0][1];
		rubik.rubik[2][0][1] = rubik.rubik[0][0][1];
		rubik.rubik[0][0][1] = t;

		t = rubik.rubik[1][2][1];
		rubik.rubik[1][2][1] = rubik.rubik[2][1][1];
		rubik.rubik[2][1][1] = rubik.rubik[1][0][1];
		rubik.rubik[1][0][1] = rubik.rubik[0][1][1];
		rubik.rubik[0][1][1] = t;
	}
...
var rotate_z3 = function()
{
	...
	var swapCubes = function() {
		...
		rubik.rubik[0][2][0] = rubik.rubik[2][2][0];
		rubik.rubik[2][2][0] = rubik.rubik[2][0][0];
		rubik.rubik[2][0][0] = rubik.rubik[0][0][0];
		rubik.rubik[0][0][0] = t;

		t = rubik.rubik[1][2][0];
		rubik.rubik[1][2][0] = rubik.rubik[2][1][0];
		rubik.rubik[2][1][0] = rubik.rubik[1][0][0];
		rubik.rubik[1][0][0] = rubik.rubik[0][1][0];
		rubik.rubik[0][1][0] = t;
	}
